...
You are also given the coordinates for a cell in the form of row and column numbers 
...
How it is used:     As we mentioned in the beginning, this idea can be useful for developing 
